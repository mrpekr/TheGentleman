...
#Config:
richpresence = True #Výchozý: True (Ukazuje že používáš "Genglemanana" jako aktivitu na Discordu)
customsalutation = False #Výchozý: False ("Gentleman" tě bude nazívat tvým jménem)
...
if customsalutation == False:
    ...
    if file_exists == True:
            ...
            def MenuN():
                ...
                print("Co pro tebe můžu udělat " + name + "?")
                print("\x1b[38;5;199m[1] Řekni mi vtip (Bez Překladu)")
                print("[2] Řekni mi mou budoucnost (Bez Překladu)")
                print("[3] Řekni mi kolik je hodin")
                print("[4] Tady Nic Není")
                menuN = input("\x1b[38;5;85mZadej Čáslo: ")
                print("\x1b[38;5;255m")
                if menuN == "1":
                    def Joke():
        ...
        time.sleep(5)
        name = input("Zadej Prosím Své Jméno: ")
